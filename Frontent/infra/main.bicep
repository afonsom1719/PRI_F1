...
param apiType string = 'azure'
param apiVersion string = ''
param azureBlobSasToken string = ''
param azureFileUploadContainer string = ''
param azureOpenAIGptFunctionsDeployment string = ''
param azureSearchIndexer string = ''
param azureStorageConnectionString string = ''
param dallEImageSize string = ''
...
var tags = { 'azd-env-name': environmentName, creator: 'Eduardo Silva' }
...
module backend 'core/host/appservice.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      AZURE_FILE_UPLOAD_CONTAINER: azureFileUploadContainer
      AZURE_OPENAI_GPT_FUNCTIONS_DEPLOYMENT: azureOpenAIGptFunctionsDeployment
      AZURE_SEARCH_INDEXER: azureSearchIndexer
      AZURE_STORAGE_CONNECTION_STRING: azureStorageConnectionString
      DALLE_IMAGE_SIZE: dallEImageSize
